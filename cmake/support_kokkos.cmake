...
# Macro to optionally find and link KokkosComm.
macro(findKokkosComm_LK external_libs)
    find_package(KokkosComm QUIET)
    if(KokkosComm_FOUND)
        message(STATUS "KokkosComm found.")
        target_link_libraries(${external_libs} INTERFACE KokkosComm::KokkosComm)
    else()
        message(WARNING "KokkosComm not found. Falling back to MPIManagerKokkos communication path.")
    endif()
endmacro()
